		    ...
		    <ul class="navbar-nav mr-auto">
		      ...
		      <li class="nav-item dropdown ">
		        ...
		        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
		          ...
		          <a class="dropdown-item" href="ride.php?action=complete">Cancelled Rides</a>
		      ...
		      <li class="nav-item dropdown ">
		        ...
		        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
		          <a class="dropdown-item" href="changeinfo.php?action=update">Pending Users Request</a>
		          <a class="dropdown-item" href="changepassword.php">Approved users Request</a>
