			...
			<div class="table">
				...
				<table>
					...
					foreach ($ar as $key) 
					{
						...
						{
							echo "<td><a class='active' href='?type=status&operation=deactive&id=".$key['id']."'>Active</a>";
						}
						else
						{
							echo "<td><a class='deactive' href='?type=status&operation=active&id=".$key['id']."'>Deactive</a>";	
						}?>			
							<td> <a href="location.php?operation=edit&id=<?php echo $key['id'];?>">edit</a>
							<a href="location.php?operation=delete&id=<?php echo $key['id'];?>">delete</a>
						</td>
						<?php echo '</tr>';	
					}
					?>
