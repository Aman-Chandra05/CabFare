			...
			<div class="bg-light p-3 rounded">
				...
				<div class="input-group mb-3">
					<div class="input-group-prepend">
					  ...
					  <option class="location" value="charbagh">Charbagh</option>
					  <option class="location" value="indranagar">Indra Nagar</option>
					  <option class="location" value="bbd">BBD</option>
					  <option class="location" value="barabanki">Barabanki</option>
					  <option class="location" value="faizabad">Faizabad</option>
					  <option class="location" value="basti">Basti</option>
					  <option class="location" value="gorakhpur">Gorakhpur</option>
					</select>
				</div>
